...
export default function MilitaryForm() {
  ...
  return (
    <div className="max-w-6xl mx-auto py-8 px-4 sm:px-6">
      ...
      <div className="relative overflow-hidden bg-gradient-to-l from-green-400 to-green-600 rounded-2xl shadow-xl mb-8">
      ...
      <div className="bg-white rounded-xl shadow-md p-6 mb-6">
        ...
        <form className="space-y-6" onSubmit={handleSubmit}>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-1">תאריך סיום שירות</label>
              <input
                type="date"
                name="endDate"
                ...
                className="w-full border border-gray-300 rounded-lg p-3 focus:ring-2 focus:ring-green-500 focus:border-green-500"
              />
              <p className="text-xs text-gray-500 mt-1">אם היום הראשון בלבד, אין צורך למלא תאריך סיום</p>
            </div>
          </div>

          <div>
            <label className="block text-sm font-medium text-gray-700 mb-1">יחידה / מספר צו</label>
            <input
              type="text"
              name="unit"
              placeholder="הכנס את פרטי היחידה או מספר הצו"
              required
              value={formData.unit}
              onChange={handleChange}
              className="w-full border border-gray-300 rounded-lg p-3 focus:ring-2 focus:ring-green-500 focus:border-green-500 text-right"
            />
          </div>
          ...
          <div className="mx-auto max-w-3xl">
            ...
            <textarea
              name="notes"
              placeholder="פרט את בקשתך (דחיית מבחנים, הגשת עבודות וכו')"
              rows={4}
          ...
          <div className="flex justify-center">
            <button
              ...
              className={`px-6 py-3 bg-gradient-to-r from-green-400 to-green-600 text-white font-semibold rounded-lg shadow-md hover:from-green-500 hover:to-green-700 focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-opacity-50 ${
