...
export default function ExemptionForm() {
  ...
  return (
    <div className="max-w-6xl mx-auto py-8 px-4 sm:px-6">
      ...
      <div className="relative overflow-hidden bg-gradient-to-l from-yellow-400 to-yellow-600 rounded-2xl shadow-xl mb-8">
        ...
        <form className="space-y-6" onSubmit={handleSubmit}>
          ...
          <div className="flex justify-center">
            <button
              ...
              className={`px-6 py-3 bg-gradient-to-r from-yellow-400 to-yellow-600 text-white font-semibold rounded-lg shadow-md hover:from-yellow-500 hover:to-yellow-700 focus:outline-none focus:ring-2 focus:ring-yellow-500 focus:ring-opacity-50 ${
